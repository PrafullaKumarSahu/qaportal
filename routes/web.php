...
Route::get('/exams/questions/{question}', 'QuestionController@show');
Route::get('/exams/questions/{question}/edit', 'QuestionController@edit');
Route::patch('/exams/questions/{question}', 'QuestionController@update');
Route::put('/exams/questions/{question}', 'QuestionController@delete');
