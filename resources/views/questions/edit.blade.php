    	...
    	<div class="col-8 main">
		    ...
		    <form method="POST" action="/exams/{{$exam->id}}/questions/{$question->id}/update">
                ...
                {{--
                    ...
                    @foreach ( $options as $option )
                        <div class="form-group row">
                            <label for="option" class="col-sm-2 col-form-label">Option 1</label>
                            <input type="text" class="form-control col-sm-10" id="option" value="{{$option->description}}" name="option_1">
                        </div>        
                    @endforeach
                @endif
                    --}}
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-10" id="option_1" placeholder="Option 1" name="option_1">
                </div>
                <div class="form-group row">
